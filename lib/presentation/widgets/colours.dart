...
class AppColors {
  static const Color darkBlue = Color(0xFF172832);
   static Color lightBlue = const Color.fromARGB(255, 219, 241, 247);
  static const Color buttonBlue = Color(0xFF1E88E5); 
  static const Color buttonBackground = Color(0xFF1F3A47);// Match sample app button
