                            ...
                            Container(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Text('1216',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 25)),
                                  Text('Carm',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold),),
                                ],
                              ),
                            )
                          ],
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Image.asset('assets/images/stethoscope_icon.png'),
                            ),
                            Container(
                              padding: EdgeInsets.all(15),
                              decoration: BoxDecoration(
